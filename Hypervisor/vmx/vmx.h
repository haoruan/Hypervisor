...
#define	VMX_VMXONR_SIZE	PAGE_SIZE
#define	VMX_VMCS_SIZE	PAGE_SIZE
#define	VMX_IOBitmap_SIZE	PAGE_SIZE
#define	VMX_MSRBitmap_SIZE	PAGE_SIZE
...
static NTSTATUS VmxFillGuestSelectorData(PVOID GdtBase, ULONG Segreg, USHORT Selector);

VOID VmxCrash(PCPU Cpu, PGUEST_REGS GuestRegs);
VOID VmxDisable();

//Asm
VOID NTAPI VmxVmCall(ULONG32 HypercallNumber);
VOID NTAPI VmxVmexitHandler();
VOID NTAPI VmxByeHyper(PGUEST_REGS GuestRegs);
